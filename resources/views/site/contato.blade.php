...
<head>
    ...
    <title>Contato - Portal do Aluno</title>
...
<header class="bg-stone-950 border-b-2 border-red-700 sticky top-0 z-50 shadow-lg">
    ...
    <!-- SEÇÃO DE CONTATO -->
<main class="container mx-auto px-6 py-12 max-w-3xl space-y-12">
    <h1 class="text-4xl font-bold text-center mb-10 text-red-500">Entre em Contato</h1>

    <form action="#" method="POST" class="bg-stone-950 p-8 rounded-xl shadow-lg border border-stone-700">
        <!-- Nome -->
        <div class="mb-6">
            <label for="nome" class="block text-sm font-medium mb-2 text-stone-300">Nome</label>
            <input type="text" id="nome" name="nome" required
                   class="w-full px-4 py-2 rounded-lg bg-stone-900 border border-stone-700 text-white focus:outline-none focus:ring-2 focus:ring-red-600">
        </div>

        <!-- E-mail -->
        <div class="mb-6">
            <label for="email" class="block text-sm font-medium mb-2 text-stone-300">E-mail</label>
        ...
        <!-- Mensagem -->
        <div class="mb-6">
            <label for="mensagem" class="block text-sm font-medium mb-2 text-stone-300">Mensagem</label>
            <textarea id="mensagem" name="mensagem" rows="5" required
                      class="w-full px-4 py-2 rounded-lg bg-stone-900 border border-stone-700 text-white focus:outline-none focus:ring-2 focus:ring-red-600"></textarea>
        </div>

        <!-- Botão -->
        <div class="text-center">
            <button type="submit" class="bg-red-700 hover:bg-red-800 text-white px-6 py-3 rounded-lg font-semibold transition-colors">
                Enviar Mensagem
            </button>
        </div>
    </form>
    ...
    <!-- Contato do Site -->
    <div class="bg-stone-950 p-6 rounded-xl border border-stone-700 shadow-lg text-center text-stone-300">
        <h2 class="text-red-500 font-semibold text-xl mb-3">Contato do Site</h2>
        <p>Rua das Notas Boas, 165 C - São Paulo, SP</p>
        <p>Telefone: (11) 98491-2520</p>
        <p>E-mail: contato@portalaluno.com.br</p>
    </div>
</main>
